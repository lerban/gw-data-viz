...
kable(ftn %>% arrange(id) %>% dplyr::select(station_nm, site_tp_cd, temp, SpC, pH, DO, PO4, NH34, NO3, NO23, TN, percent_organicN, percent_NO23), digits = 3, caption = paste0("Snapshot of ", ym, " sampling results"))
...
p <- ggplot(a, aes(x = result_va, y = well_depth_va)) +
  ...
  theme(panel.spacing.x = unit(1, "cm"), panel.spacing.y = unit(2, "cm")) +
  #theme_bw() + 
